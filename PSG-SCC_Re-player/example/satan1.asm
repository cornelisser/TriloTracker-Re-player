...
.waveform_start:
	...
	db $00, $20, $30, $40, $30, $20, $e0, $c0, $b0, $c0, $e0, $20, $40, $60, $70, $70, $60, $40, $20, $e0, $b0, $90, $80, $80, $80, $80, $90, $a0, $c0, $d0, $e0, $f0				; Waveform:16
	db $00, $19, $31, $47, $5a, $6a, $75, $7d, $7f, $7d, $75, $6a, $5a, $47, $31, $19, $00, $f0, $e0, $d0, $c0, $b0, $a0, $90, $80, $90, $a0, $b0, $c0, $d0, $e0, $f0				; Waveform:17
	db $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00				; Waveform:26
...
;	db $02,$10						; Mixer
	db $00							; End of row.
.rst_i09:							; Loop address
;	db $02,$10						; Mixer
	db $18,$ff						; Loop (-2)

.instrument_10:					; IN              
	db $18							; Waveform 3
.rst_i10:							; Loop address
;	db $02,$10						; Mixer
	db $08,$0f						; Volume _
	db $18,$fd						; Loop (-4)
...
.track_004:
	...
	db $6d			;Volume 12
	db $77			;Instrument 6
			;CMD bb5 Waveform Not valid [WARNING]
	db $c6			;Wait 7
	db $9c,$58			; SCC Morph to Waveform 26
	db $c0			;Wait 1
	db $6c			;Volume 11
	db $c3			;Wait 4
	db $6b			;Volume 10
	...
	db $c3			;Wait 4
	db $68			;Volume 7
			;CMD c50 Waveform Not valid [WARNING]
					;Wait Repeat 4
	db $67			;Volume 6
					;Wait Repeat 4
	db $66			;Volume 5
	db $cc			;Wait 13
	db $9c,$48			; SCC Morph to Waveform 16
	db $d2			;Wait 19
	db $bf			;[End-Of-Track]
.track_005:
	db $10			;Note E-2
	...
	db $66			;Volume 5
	db $79			;Instrument 8
			;CMD bbc Waveform Not valid [WARNING]
	db $c4			;Wait 5
	db $94,$55		;CMD Vibrato
	db $c5			;Wait 6
	db $9b			;CMD End 
...
.track_014:
	...
	db $67			;Volume 6
	db $7a			;Instrument 9
			;CMD bb7 Waveform Not valid [WARNING]
	db $c1			;Wait 2
	db $1d			;Note F-3
					;Wait Repeat 2
	db $1c			;Note E-3
...
.track_029:
	...
	db $69			;Volume 8
	db $79			;Instrument 8
			;CMD bb3 Waveform Not valid [WARNING]
	db $c4			;Wait 5
	db $94,$85		;CMD Vibrato
	db $c8			;Wait 9
...
.track_030:
	...
	db $67			;Volume 6
	db $7a			;Instrument 9
			;CMD bbb Waveform Not valid [WARNING]
	db $c1			;Wait 2
	db $0e			;Note D-2
					;Wait Repeat 2
	db $10			;Note E-2
...
.track_069:
	...
	db $27			;Note D#4
	db $6b			;Volume 10
			;CMD bc3 Waveform Not valid [WARNING]
					;Wait Repeat 2
	db $68			;Volume 7
					;Wait Repeat 2
	db $27			;Note D#4
...
.track_092:
	...
	db $69			;Volume 8
	db $77			;Instrument 6
			;CMD bb8 Waveform Not valid [WARNING]
	db $c0			;Wait 1
	db $9c,$50			; SCC Morph to Waveform 17
					;Wait Repeat 1
	db $68			;Volume 7
	db $c1			;Wait 2
	db $67			;Volume 6
	...
	db $09			;Note A-1
	db $69			;Volume 8
			;CMD bb2 Waveform Not valid [WARNING]
	db $c0			;Wait 1
	db $9c,$50			; SCC Morph to Waveform 17
					;Wait Repeat 1
	db $68			;Volume 7
...
.track_134:
	...
	db $6b			;Volume 10
	db $7c			;Instrument 11
			;CMD bb4 Waveform Not valid [WARNING]
	db $c2			;Wait 3
	db $68			;Volume 7
	db $94,$53		;CMD Vibrato
					;Wait Repeat 3
