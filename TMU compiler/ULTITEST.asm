...
.track_017:
	...
	db $bf			;[End-Of-Track]
.track_018:
	db $9e,$08			;CMD Arpegio speed
	db $c7			;Wait 8
	db $9e,$04			;CMD Arpegio speed
					;Wait Repeat 8
	db $9e,$01			;CMD Arpegio speed
	db $cf			;Wait 16
	db $30			;Note C-5
...
.track_020:
	db $60			;Release 96
	db $f5			;Wait 54
	db $ac,$01			; SCC Morph follow (Carbon C0poy) 1
	db $c0			;Wait 1
	db $ad,$01			; SCC Morph speed 1
					;Wait Repeat 1
	db $05			;Note F-1
	db $6f			;Volume 13
	db $76			;Instrument 4
	db $aa,$20			; SCC Set Waveform 4
					;Wait Repeat 1
	db $9d,$98			; SCC Morph to Waveform 31
	db $c6			;Wait 7
	db $bf			;[End-Of-Track]
.track_024:
	db $5d			;Note A-8
...
.track_025:
	...
	db $6f			;Volume 13
	db $76			;Instrument 4
	db $96,$0c			;CMD Portamento up
	db $c3			;Wait 4
	db $93,$0c			;CMD Portamento down
					;Wait Repeat 4
	db $24			;Note C-4
	db $6f			;Volume 13
	...
	db $93,$02			;CMD Portamento down
					;Wait Repeat 4
	db $93,$04			;CMD Portamento down
					;Wait Repeat 4
	db $93,$08			;CMD Portamento down
					;Wait Repeat 4
	db $93,$0f			;CMD Portamento down
					;Wait Repeat 4
	db $93,$20			;CMD Portamento down
					;Wait Repeat 4
	db $93,$40			;CMD Portamento down
					;Wait Repeat 4
	db $60			;Release 96
	db $c3			;Wait 4
	db $2d			;Note A-4
	db $71			;Volume 15
	db $93,$a0			;CMD Portamento down
	db $c2			;Wait 3
	db $60			;Release 96
	db $c0			;Wait 1
	db $05			;Note F-1
	db $96,$a0			;CMD Portamento up
	db $c2			;Wait 3
	db $60			;Release 96
	db $bf			;[End-Of-Track]
.track_026:
	db $9f,$0f			;CMD Portamento fine up
	db $c3			;Wait 4
	db $a0,$ff			;CMD Portamento fine up
	db $d3			;Wait 20
	db $9f,$01			;CMD Portamento fine up
	db $e7			;Wait 40
	db $bf			;[End-Of-Track]
.track_027:
	db $60			;Release 96
...
.track_035:
	...
	db $71			;Volume 15
	db $76			;Instrument 4
	db $aa,$80			; SCC Set Waveform 20
	db $c0			;Wait 1
	db $93,$0a			;CMD Portamento down
	db $c3			;Wait 4
...
.track_065:
	...
	db $91,$01			;CMD Portamento tone
					;Wait Repeat 1
	db $92,$89			;CMD Portamento tone + Volume slide
	db $cd			;Wait 14
	db $2e			;Note A#4
	db $71			;Volume 15
	db $c1			;Wait 2
	db $95,$68			;CMD Vibrato
	db $c0			;Wait 1
	db $97,$89			;CMD Vibrato + Volume slide
	db $cc			;Wait 13
	db $20			;Note G#3
	db $71			;Volume 15
	db $9c			;CMD End 
	...
	db $91,$04			;CMD Portamento tone
					;Wait Repeat 1
	db $92,$83			;CMD Portamento tone + Volume slide
	db $c5			;Wait 6
	db $2e			;Note A#4
	db $71			;Volume 15
	db $c1			;Wait 2
	db $95,$68			;CMD Vibrato
	db $c0			;Wait 1
	db $97,$83			;CMD Vibrato + Volume slide
	db $c4			;Wait 5
	db $bf			;[End-Of-Track]
.track_066:
	db $ef			;Wait 48
...
.track_073:
	...
	db $70			;Volume 14
	db $76			;Instrument 4
	db $99,$7b			;CMD Tremolo
	db $cf			;Wait 16
	db $38			;Note G#5
	db $99,$3f			;CMD Tremolo
					;Wait Repeat 16
	db $20			;Note G#3
	db $70			;Volume 14
	db $99,$83			;CMD Tremolo
					;Wait Repeat 16
	db $20			;Note G#3
	db $71			;Volume 15
	db $99,$87			;CMD Tremolo
	db $cf			;Wait 16
	db $bf			;[End-Of-Track]
.track_080:
	db $df			;Wait 32
	...
	db $5d			;Note A-8
	db $6f			;Volume 13
	db $a6,$af			;CMD Envelope multiplier low
					;Wait Repeat 4
	db $5d			;Note A-8
	db $6f			;Volume 13
					;Wait Repeat 4
...
.track_081:
	...
	db $c2			;Wait 3
	db $a5,$00			;CMD Envelope multiplier high
	db $c0			;Wait 1
	db $3c			;Note C-6
	db $a6,$50			;CMD Envelope multiplier low
	db $c3			;Wait 4
	db $54			;Note C-8
	db $a6,$10			;CMD Envelope multiplier low
					;Wait Repeat 4
	db $1f			;Note G-3
	db $a5,$30			;CMD Envelope multiplier high
	db $c9			;Wait 10
	db $a6,$00			;CMD Envelope multiplier low
	db $c0			;Wait 1
	db $a5,$00			;CMD Envelope multiplier high
					;Wait Repeat 1
	db $59			;Note F-8
	db $73			;Instrument 1
	db $a6,$09			;CMD Envelope multiplier low
	db $c6			;Wait 7
	db $a6,$00			;CMD Envelope multiplier low
	db $c0			;Wait 1
	db $1d			;Note F-3
	db $77			;Instrument 5
	db $a5,$04			;CMD Envelope multiplier high
	db $cf			;Wait 16
	db $10			;Note E-2
	db $78			;Instrument 6
	db $a5,$0f			;CMD Envelope multiplier high
	db $cf			;Wait 16
	db $bf			;[End-Of-Track]
.track_082:
	db $60			;Release 96
...
.track_093:
	...
	db $aa,$48			; SCC Set Waveform 10
					;Wait Repeat 2
	db $aa,$00			; SCC Set Waveform 0
					;Wait Repeat 2
	db $aa,$78			; SCC Set Waveform 19
					;Wait Repeat 2
	db $aa,$80			; SCC Set Waveform 20
					;Wait Repeat 2
	db $aa,$88			; SCC Set Waveform 22
					;Wait Repeat 2
	...
	db $95,$75			;CMD Vibrato
	db $c0			;Wait 1
	db $97,$8b			;CMD Vibrato + Volume slide
	db $cc			;Wait 13
	db $28			;Note E-4
	db $71			;Volume 15
	db $7b			;Instrument 9
...
.track_099:
	...
	db $aa,$58			; SCC Set Waveform 12
	db $c0			;Wait 1
	db $ad,$00			; SCC Morph speed 0
					;Wait Repeat 1
	db $ac,$01			; SCC Morph follow (Carbon C0poy) 1
	db $c1			;Wait 2
	db $9d,$10			; SCC Morph to Waveform 2
	db $c3			;Wait 4
	db $9d,$58			; SCC Morph to Waveform 12
					;Wait Repeat 4
	db $9d,$10			; SCC Morph to Waveform 2
					;Wait Repeat 4
	db $26			;Note D-4
	...
	db $9d,$58			; SCC Morph to Waveform 12
					;Wait Repeat 4
	db $9d,$90			; SCC Morph to Waveform 28
					;Wait Repeat 4
	db $9d,$68			; SCC Morph to Waveform 16
					;Wait Repeat 4
	db $9d,$00			; SCC Morph to Waveform 0
	db $c3			;Wait 4
	db $bf			;[End-Of-Track]
.track_100:
	db $05			;Note F-1
	...
	db $2b			;Note G-4
	db $6d			;Volume 11
	db $ab				; SCC Morph foloow (Carbon C0poy) 0
	db $df			;Wait 32
	db $bf			;[End-Of-Track]
.track_101:
	db $ad,$02			; SCC Morph speed 2
	db $cf			;Wait 16
	db $60			;Release 96
	db $cf			;Wait 16
	db $2f			;Note B-4
...
.track_105:
	...
	db $70			;Volume 14
	db $75			;Instrument 3
	db $a2,$07			;CMD Track detune
	db $c1			;Wait 2
	db $41			;Note F-6
	db $a2,$06			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$05			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	...
	db $a2,$08			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$09			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0a			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0b			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0c			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0d			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0e			;CMD Track detune
					;Wait Repeat 2
	db $41			;Note F-6
	db $a2,$0f			;CMD Track detune
					;Wait Repeat 2
	db $60			;Release 96
	db $c1			;Wait 2
	db $41			;Note F-6
...
.track_107:
	...
	db $c0			;Wait 1
	db $2b			;Note G-4
	db $9b,$03			;CMD Note delay
					;Wait Repeat 1
	db $2d			;Note A-4
	db $9b,$05			;CMD Note delay
	db $c1			;Wait 2
	db $2e			;Note A#4
	db $c0			;Wait 1
	db $2d			;Note A-4
